...
public class CommentsRestController {
    ...
    private final CommentsResponseDtoService commentsResponseDtoService;
    private final CommentsService commentsService;
    private final CommentsMapper commentsMapper;


    public CommentsRestController(CommentsResponseDto commentsResponseDto,
                                  CommentsResponseDtoService commentsResponseDtoService,
                                  CommentsService commentsService,
                                  CommentsMapper commentsMapper) {
        this.commentsResponseDto = commentsResponseDto;
        this.commentsResponseDtoService = commentsResponseDtoService;
